...
class DoodleDash extends FlameGame
  ...
  late Player player; // Add a Player to the game: Create a Player variable
  ...
  void initializeGameStart() {
    setCharacter(); // Add a Player to the game: Call setCharacter
    ...
    player
        .resetPosition(); // Add a Player to the game: Reset Dash's position back to the start
  ...
  void checkLevelUp() {
    if (levelManager.shouldLevelUp(gameManager.score.value)) {
      ...
      player.setJumpSpeed(
          levelManager.jumpSpeed); // Core gameplay: Call setJumpSpeed
    }
  }
}
